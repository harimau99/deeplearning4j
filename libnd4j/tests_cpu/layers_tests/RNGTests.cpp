...
TEST_F(RNGTests, test_multinomial_3) {
    ...
    // NDArray expected('c', {  4, 5 }, { 0, 1, 0, 2, 2,   2, 2, 2, 1, 0,   1, 0, 2 , 1, 0,  1, 0, 0, 0, 0 }, nd4j::DataType::INT64);
...
TEST_F(RNGTests, test_multinomial_4) {
    ...
    // NDArray expected('c', { 5, 4 }, { 0, 1, 0, 2, 2,  2, 1, 0, 0, 0,  1, 0, 2, 1, 0,  1, 0, 2, 2, 1  }, nd4j::DataType::INT64);
    nd4j::ops::random_multinomial op;
